...
def decrypt():
    ...
    if password=="1234":
          ...
          text2=Text(screen2,font="Rpbote 25",bg="white",relief=GROOVE,wrap=WORD,bd=0)
          text2.place(x=10,y=40,width=380,height=150)

          text2.insert(END,decrypt)

    elif password=="":
         messagebox.showerror("encryption","Input Key")
...
def encrypt():
     ...
     if password=="1234":
          ...
          text2=Text(screen1,font="Rpbote 25",bg="white",relief=GROOVE,wrap=WORD,bd=0)
          text2.place(x=10,y=40,width=380,height=150)
